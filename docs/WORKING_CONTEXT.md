...
- 记录：
  ...
  - 2026-03-08 验证：已通过 `npm run type-check`。
    ...
    - 2026-03-08 后续追加：复核后确认 `README.md` 仍停留在项目初始化描述，和当前已落地的登录、动态菜单/路由、403/404 与订单演示页状态明显脱节，需要同步更新对外说明。
    - 2026-03-08 开始实现：计划仅更新 `README.md`，补齐项目定位、当前已实现能力、演示账号、目录结构和已知限制等说明，不改动业务代码或全局状态区。
    - 2026-03-08 完成：已重写 `README.md`，同步补齐项目定位、当前已实现能力、演示账号、常用命令、目录结构和当前限制说明，使 README 与当前项目状态保持一致。
    - 2026-03-08 验证：已按 UTF-8 复读确认 `README.md` 中文内容和命令说明正常，且项目现状描述已与主线记录对齐。
